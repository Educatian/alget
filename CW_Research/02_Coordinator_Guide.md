...
| **Prototype** | ALGET: Generative Multi-Agent Architecture for Bio-Inspired Engineering Education |
...
- **Multi-Agent Intelligent Textbook** for Statics & Dynamics (Mechanical Engineering)
- Teaches engineering through the lens of **Bio-Inspired Design (Biomimicry)**
- Features 4 AI Agents: Orchestrator, Tutor, Janine (Evaluator), Engineer

### Core Features (Evaluation Scope)

| Feature | Description | Relevant Agent |
|---------|-------------|----------------|
| **Generative Bio-Design Lab** | Student prompt → AI synthesizes biology + engineering | Orchestrator |
| **Scaffolding** | Socratic questioning for step-by-step guidance | Tutor |
| **Validation & Critique** | Feedback based on Janine Benyus' Life's Principles | Janine |
| **Engineering Analysis** | FBDs, simulations, mechanics analysis | Engineer |
| **Simulation** | Interactive HTML-based simulations | Engineer |
| **Content Navigation** | Browsing the 19 sections of Statics/Dynamics | System |
...
- [x] Metacognitive Support — Janine's reflective feedback
...
| E3 | Domain SME (Mech Eng) | Content accuracy, FBD representation | ☐ Pending |
