...
def gen_08():
    ...
    blank_line(doc, "", 2)
    para(doc, "4. How useful were the LXD & Intelligent Features add-on questions (L1–L8)?")
    ...
    h1(doc, "Section 3: Learning Experience & UX")
    para(doc, "8. Did the system successfully balance cognitive load across tasks?")
    para(doc, "   ☐ Strongly Agree  ☐ Agree  ☐ Neutral  ☐ Disagree  ☐ Strongly Disagree")
    para(doc, "9. How naturally did the system prompt learner metacognition?")
    para(doc, "   ☐ Very Naturally  ☐ Naturally  ☐ Neutral  ☐ Unnaturally  ☐ Poorly")

    h1(doc, "Section 4: AI Agent Evaluation")
    para(doc, "10. Rate the educational usefulness of each AI Agent (1=Very Low, 5=Very High):")
    add_table(doc,
        ["Agent", "1", "2", "3", "4", "5", "N/A"],
        [
    ...
    para(doc, "11. Overall quality of AI responses (Accuracy, Relevance, Helpfulness):")
    para(doc, "   ☐ 1  ☐ 2  ☐ 3  ☐ 4  ☐ 5")
    para(doc, "12. Did AI response latency negatively impact the learning experience?")
    para(doc, "   ☐ Not at all  ☐ Slightly  ☐ Moderately  ☐ Significantly  ☐ Very Much")

    h1(doc, "Section 5: Recommendations")
    para(doc, "13. The single most critical issue that must be fixed immediately:")
    blank_line(doc, "", 2)
    para(doc, "14. A long-term structural issue that needs redesign:")
    blank_line(doc, "", 2)
    para(doc, "15. Additional Comments:")
    blank_line(doc, "", 3)
...
def gen_03_enhanced():
    ...
    doc.add_paragraph()
    h3(doc, "CW Analysis Tables (LXD & Intelligent Features)")
    add_table(doc,
        ["Step#", "Q1 Goal", "Q2 Find", "Q3 Undrst", "Q4 Fdbk", "L1 Objectiv", "L2 Engage", "L3 C.Load", "L4 Scaffold"],
        [["","","","","","","","",""] for _ in range(6)])

    doc.add_paragraph()
    add_table(doc,
        ["Step#", "L5 Adaptivity", "L6 Transparency", "L7 Metacog", "L8 Flow"],
        [["","","","",""] for _ in range(6)])
