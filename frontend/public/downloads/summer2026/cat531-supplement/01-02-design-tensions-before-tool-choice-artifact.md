# CAT 531 Artifact Studio Packet: Design Tensions Before Tool Choice

## Purpose
This packet turns **Design Tensions Before Tool Choice** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.
