# CAT 531 Artifact Studio Packet: Risk Mitigation and Family Communication

## Purpose
This packet turns **Risk Mitigation and Family Communication** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.

## Artifact
**school AI policy memo with privacy, equity, consent, and learning-purpose checks**

## Course Context
Module: **Final Project and Professional Vision**  
...
Strong trace: "I asked for three alternatives for the school AI policy memo with privacy, equity, consent, and learning-purpose checks. I accepted the alternative that made the audience constraint explicit, rejected the alternative that removed the evidence source, and revised the artifact so the reader can see how TPACK shaped the final decision. The remaining limitation is that the trace has not yet been tested with a second reader."
