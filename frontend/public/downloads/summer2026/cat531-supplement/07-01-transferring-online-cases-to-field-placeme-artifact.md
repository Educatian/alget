# CAT 531 Artifact Studio Packet: Transferring Online Cases to Field Placements

## Purpose
This packet turns **Transferring Online Cases to Field Placements** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.

## Artifact
**field-placement transfer note connecting tool choice to classroom constraints**

## Course Context
Module: **Field-Based Transfer and Coaching**  
Course focus: **teacher technology judgment and AI ethics**
...
Strong trace: "I asked for three alternatives for the field-placement transfer note connecting tool choice to classroom constraints. I accepted the alternative that made the audience constraint explicit, rejected the alternative that removed the evidence source, and revised the artifact so the reader can see how TPACK shaped the final decision. The remaining limitation is that the trace has not yet been tested with a second reader."
