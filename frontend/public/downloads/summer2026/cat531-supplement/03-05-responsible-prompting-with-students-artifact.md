# CAT 531 Artifact Studio Packet: Responsible Prompting With Students

## Purpose
This packet turns **Responsible Prompting With Students** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.

## Artifact
**TeachGen@i prompt transcript with teacher edits and rejected suggestions**

## Course Context
Module: **AI in Education**  
