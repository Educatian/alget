# CAT 531 Artifact Studio Packet: Evidence-Based Reflection

## Purpose
This packet turns **Evidence-Based Reflection** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.
