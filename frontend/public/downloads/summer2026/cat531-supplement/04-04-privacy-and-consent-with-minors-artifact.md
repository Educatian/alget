# CAT 531 Artifact Studio Packet: Privacy and Consent With Minors

## Purpose
This packet turns **Privacy and Consent With Minors** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.

## Artifact
**school AI policy memo with privacy, equity, consent, and learning-purpose checks**

## Course Context
Module: **AI Ethics and Ethobot 3.2**  
