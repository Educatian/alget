# CAT 531 Artifact Studio Packet: TeachGen@i Scenario Setup

## Purpose
This packet turns **TeachGen@i Scenario Setup** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.
