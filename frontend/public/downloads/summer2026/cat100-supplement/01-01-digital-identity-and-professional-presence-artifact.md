# CAT 100 Artifact Studio Packet: Digital Identity and Professional Presence

## Purpose
This packet turns **Digital Identity and Professional Presence** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.

## Artifact
**resume before-after revision with truthful evidence, role fit, and AI-use note**

## Course Context
Module: **Digital Citizenship and AI Readiness**  
Course focus: **undergraduate digital fluency and AI-assisted productivity**
...
2. **Constraint:** Which course idea limits or shapes the decision. Use at least one of: NACE career readiness, ISTE digital citizenship, data-ink and visual evidence, WCAG accessibility.
...
Strong trace: "I asked for three alternatives for the resume before-after revision with truthful evidence, role fit, and AI-use note. I accepted the alternative that made the audience constraint explicit, rejected the alternative that removed the evidence source, and revised the artifact so the reader can see how NACE career readiness shaped the final decision. The remaining limitation is that the trace has not yet been tested with a second reader."
