# CAT 100 Artifact Studio Packet: Peer Showcase Feedback

## Purpose
This packet turns **Peer Showcase Feedback** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.
