# CAT 100 Artifact Studio Packet: Website Purpose and Information Architecture

## Purpose
This packet turns **Website Purpose and Information Architecture** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.

## Artifact
**GitHub Pages file tree with accessibility, privacy, and publishing checks**
...
Strong trace: "I asked for three alternatives for the GitHub Pages file tree with accessibility, privacy, and publishing checks. I accepted the alternative that made the audience constraint explicit, rejected the alternative that removed the evidence source, and revised the artifact so the reader can see how NACE career readiness shaped the final decision. The remaining limitation is that the trace has not yet been tested with a second reader."
