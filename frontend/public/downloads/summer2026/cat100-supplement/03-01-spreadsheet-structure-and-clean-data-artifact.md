# CAT 100 Artifact Studio Packet: Spreadsheet Structure and Clean Data

## Purpose
This packet turns **Spreadsheet Structure and Clean Data** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.

## Artifact
**Excel pivot-table finding with unit labels, source note, and claim-first chart title**

## Course Context
Module: **Data Storytelling With Excel**  
