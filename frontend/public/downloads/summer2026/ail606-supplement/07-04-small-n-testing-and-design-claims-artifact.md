# AIL 606 Artifact Studio Packet: Small-N Testing and Design Claims

## Purpose
This packet turns **Small-N Testing and Design Claims** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.

## Artifact
**moderated usability test script with observation-to-revision trace**

## Course Context
Module: **Research Translation for Learning Design**  
