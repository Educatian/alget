# AIL 606 Artifact Studio Packet: Final Prototype Quality Review

## Purpose
This packet turns **Final Prototype Quality Review** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.
