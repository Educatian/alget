# AIL 606 Artifact Studio Packet: Learning Metrics and Usability Metrics

## Purpose
This packet turns **Learning Metrics and Usability Metrics** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.

## Artifact
**moderated usability test script with observation-to-revision trace**

## Course Context
Module: **Usability Testing and Learning Evidence**  
...
2. **Constraint:** Which course idea limits or shapes the decision. Use at least one of: Mayer multimedia learning, cognitive load theory, UDL student variability, usability heuristics.
...
Strong trace: "I asked for three alternatives for the moderated usability test script with observation-to-revision trace. I accepted the alternative that made the audience constraint explicit, rejected the alternative that removed the evidence source, and revised the artifact so the reader can see how Mayer multimedia learning shaped the final decision. The remaining limitation is that the trace has not yet been tested with a second reader."
