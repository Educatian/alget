# AIL 606 Artifact Studio Packet: Signaling and Segmenting in Practice

## Purpose
This packet turns **Signaling and Segmenting in Practice** into a concrete artifact studio task. The goal is not to make a polished submission on the first pass. The goal is to make your judgment visible enough that an instructor, peer, or future version of you can review the decision.
