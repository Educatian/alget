...
TASK: Create an engaging narrative that teaches the selected engineering concepts through a compelling story set at UA.

REQUIREMENTS:
1. Write a 400-600 word story with a clear beginning, middle, and end
...
{{
    ...
    "story": "The full narrative text with paragraphs separated by \\n\\n",
...
TASK: Create practice activities for the given engineering concepts.

REQUIREMENTS:
1. Generate 3 questions of varying difficulty (easy, medium, challenging)
2. Each question should be UA-contextualized when possible
3. Include detailed explanations for each answer
4. Mix question types: conceptual, calculation, and application
